  ...
  return (
    <section className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-32">
      ...
      <div className="relative grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        >
          <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-[1.1] tracking-tight text-text-primary">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            <Button to="/advisor" size="lg" icon={ArrowRight}>
              Ask AI to Recommend
            </Button>
          ...
          <div className="relative mx-auto max-w-md lg:max-w-none">
            <GlassCard className="p-8 glow-blue">
              <div className="space-y-4">
                <motion.div
                  className="animate-float glass rounded-2xl p-6 flex items-center gap-4"
                  style={{ animationDelay: "0s" }}
                >
                  <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-red-500/20 to-orange-500/20">
                  ...
                  <div>
                    <p className="font-semibold text-text-primary">Premium Selection</p>
                    <p className="text-sm text-text-secondary">Curated collection</p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    <p className="font-semibold text-text-primary">Instant Comparison</p>
                    <p className="text-sm text-text-secondary">Smart analysis</p>
                  </div>
                </motion.div>
              </div>
            </GlassCard>
